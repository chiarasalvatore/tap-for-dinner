...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input9480619466412491905, --data-values-file, /tmp/accelerator-options18030770206503506085.json, --output-files, /tmp/ytt-output560855636530552824]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"msgbroker-crossplane-where-for-dinner","artifactVersion":"0.0.1-beta","dynamicMsgBroker":true,"dbType":"h2","enableCloudEvents":false,"empty":"","enableSecurity":false,"gatewayType":"ossscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","artifactId":"where-for-dinner","serviceNamespace":"service-instances","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"workloads","cacheType":"inmemCache","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input9036399070936018566, --data-values-file, /tmp/accelerator-options13438148418488316155.json, --output-files, /tmp/ytt-output14561089585157478779]
